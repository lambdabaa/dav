...
var accounts = require('./accounts'),
    debug = require('debug')('dav:calendars'),
    model = require('./model'),
...
function basicSync(calendar, options) {
  return new Promise(function(resolve, reject) {
    ...
    .then(function(responses) {
      ...
      if (!response) {
        return reject(
          new Error('Could not find calendar on remote. Was it deleted?')
        );
      }
 ...
 *   (dav.Transport) xhr - request sender.
 */
function sync(calendar, options) {
  var syncMethod;
...
exports.syncAccount = function(account, options) {
  ...
  return accounts.fetchCalendars(account, options)
  .then(function(cals) {
    cals
      .filter(function(cal) {
