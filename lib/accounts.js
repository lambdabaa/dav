 ...
 * rfc 6764.
 *
 * @param {dav.Account} account to find caldav url for.
 */
...
/**
 * @param {dav.Account} calendar to fetch report set for.
 */
function supportedReportSet(calendar, options) {
