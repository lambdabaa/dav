...
CalDAV.prototype = {
     ...
     * @param {String} path the name of the calendar object, such as UUID.ics
     * @param {String} data rfc 5545 VCALENDAR object.
     * @param {String} etag Optional etag, will be used to prevent missing overwrites.
     * @return {Promise} promise will resolve when the calendar has been created.
     */
     ...
     */
    sync : function(calendar, options) {
      ...
      return new Promise(function(resolve, reject) {
        ...
        client.propFind(
          ...
          console.log(response.multiStatus);
          debug('New ctag: ' + response.multiStatus[0].props.getctag);
          return resolve(calendar.ctag !== response.multiStatus[0].props.getctag);
        }, function(err) {
          return reject(err);
        });
      })
      .then(function(sync) {
        ...
        return calendarQuery(calendar).then(function(responses) {
